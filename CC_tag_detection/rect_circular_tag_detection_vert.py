...
class BullsEyeDetection:
	...
	def pnp(self, imgPoints,img):
		...
		half_long_side = 76/2
		half_short_side = 50/2
		objPoints = np.array([[-half_short_side,half_long_side,0],\
									[half_short_side,half_long_side,0],\
									[half_short_side,-half_long_side,0], \
									[-half_short_side,-half_long_side,0]], dtype=np.float64)
